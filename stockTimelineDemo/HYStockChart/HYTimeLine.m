...
-(void)draw
{
    ...
    //添加分时线颜色
    CGContextSetStrokeColorWithColor(self.context, [UIColor whiteColor].CGColor/*[UIColor timeLineLineColor].CGColor*/);
    ...
    if (count > 0) {
        [self drawLinearGradient:self.context path:fillPath alpha:0.4f startColor:[UIColor whiteColor].CGColor/*[UIColor fenShiGradientColor].CGColor*/ endColor:[UIColor colorWithRGBHex:0x7A7E89 alpha:0.6].CGColor/*[UIColor fenShiGradientColor].CGColor*/];
    }
